...
export default NotificationsUser = ({ navigation }) => {
  const [notifications, setNotifications] = useState([
    {
      imgURL: require("../../assets/imgs/userPhoto1.png"),
      name: "Doctor",
      content: "uploaded your analyze!",
      time: "1m ago",
    },
    {
      imgURL: require("../../assets/imgs/i.png"),
      name: false,
      content: "Your daily check-up refreshed!",
      time: "14m ago",
    },
  ]);
              ...
              return (
                <View style={styles.notification}>
                  ...
                  <View style={{ flexDirection: "row" }}>
                    {item.name ? <Text style={{color: "#10B584",fontSize: 14,fontWeight: "600",}}>{item.name} {" "}</Text> : ""}
                    <Text
                      style={{
                        color: "#1F1F1F",
                        fontSize: 14,
